...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_planck_mit(
                ...
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	[4] = LAYOUT_planck_mit(
                KC_TRNS, RCS(KC_TAB), RALT(KC_LEFT), RALT(KC_RGHT), RCTL(KC_TAB), KC_MPLY, KC_NO, KC_HOME, KC_PGUP, KC_PGDN, KC_END, RCS(KC_EQL), 
                KC_TRNS, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_VOLU, KC_NO, AUTO_LEFT, AUTO_UP, AUTO_DOWN, AUTO_RGHT, RCTL(KC_MINS), 
                RCTL(KC_Z), KC_TRNS, RCTL(KC_X), RCTL(KC_C), RCTL(KC_V), KC_VOLD, KC_NO, RCTL(KC_LEFT), RCTL(KC_UP), RCTL(KC_DOWN), RCTL(KC_RGHT), KC_NO, 
                KC_TRNS, KC_TRNS, KC_TRNS, MO(5), KC_NO, KC_TRNS, KC_NO, KC_NO, KC_BRID, KC_NO, KC_BRIU),
	[5] = LAYOUT_planck_mit(
                KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_SLEP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
                KC_NO, KC_F5, KC_F6, KC_F7, KC_F8, RGB_MOD, RGB_RMOD, BL_STEP, KC_NO, KC_NO, KC_NO, KC_NO, 
                KC_NO, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(1), 
                KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(0))
};
