...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NAV_LAYER] = LAYOUT_planck_mit(
                KC_TRNS, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, KC_PGUP, KC_NO, RCS(KC_TAB), RALT(KC_LEFT), RALT(KC_RGHT), RCTL(KC_TAB), KC_DEL,
                AUTO_TAB, AUTO_LEFT, AUTO_UP, AUTO_DOWN, AUTO_RGHT, KC_PGDN, KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_TRNS,
                RCTL(KC_Z), KC_LSFT, RCTL(KC_X), RCTL(KC_C), RCTL(KC_V), KC_HOME, KC_END, RCTL(KC_LEFT), RCTL(KC_UP), RCTL(KC_DOWN), RCTL(KC_RGHT), KC_RSFT,
