...
#define NAV_LAYER 5
#define NAV2_LAYER 6
#define MIDI_LAYER_CHROMATIC 7
#define MIDI_LAYER_C 8
#define FN_LAYER 9
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NAV_LAYER] = LAYOUT_planck_mit(
                ...
                LALT(KC_TAB), KC_HOME, KC_PGUP, KC_PGDN, KC_END, AUTO_DOWN, KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_TRNS,
                ...
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(NAV2_LAYER), KC_TRNS, MO(NAV2_LAYER), KC_TRNS, RCTL(KC_MINS), RCTL(KC_EQL), RCS(KC_EQL)),
	[NAV2_LAYER] = LAYOUT_planck_mit(
                KC_MS_BTN1, KC_MS_LEFT, KC_MS_UP, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_BTN2, KC_NO, RCS(KC_TAB), RALT(KC_LEFT), RALT(KC_RGHT), RCTL(KC_TAB), KC_DEL,
                LALT(KC_TAB), KC_HOME, KC_PGUP, KC_PGDN, KC_END, AUTO_DOWN, KC_NO, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_TRNS,
                RCTL(KC_Z), KC_LSFT, RCTL(KC_X), RCTL(KC_C), RCTL(KC_V), AUTO_LEFT, AUTO_RGHT, RCTL(KC_LEFT), RCTL(KC_UP), RCTL(KC_DOWN), RCTL(KC_RGHT), KC_RSFT,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(NAV2_LAYER), KC_TRNS, MO(NAV2_LAYER), KC_TRNS, RCTL(KC_MINS), RCTL(KC_EQL), RCS(KC_EQL)),
